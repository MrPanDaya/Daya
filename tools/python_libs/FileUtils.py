...
class FileUtils:
    ...
    # 修改文件名或者移动文件，包括文件和文件夹
    @staticmethod
    def rename(sourceFilePath, newFilePath):
        #Common.assertExit(os.path.isfile(sourceFilePath), "文件不存在：" + sourceFilePath)
        os.rename(sourceFilePath, newFilePath)
